...
export function CabanaTile({ tile, status, onClick }: CabanaTileProps) {
  ...
  return (
    <button
      className={`relative flex w-full aspect-square cursor-pointer items-center justify-center overflow-hidden border-2 p-0 transition-all duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-(--color-accent) focus-visible:ring-offset-1 focus-visible:z-20 ${
        isAvailable
          ? "border-(--color-available) hover:z-10 hover:scale-110 hover:shadow-md"
